MC Heli MOD 0.9.3 / MC1.7.10 [SSP/SMP]
...
前提MOD
	Minecraft Forge 1.7.10-10.13.0.1180 以降が必要です。
	(上記バージョンで動作確認を行ってます)
...
既知の問題
	...
	・ヘリコプターに乗ったままログアウト→ログインした場合、
	　3人称視点にするとヘリコプターがガタガタと激しく揺れる。
	　→ ヘリコプターに乗ったままログアウトしないことで回避可能
